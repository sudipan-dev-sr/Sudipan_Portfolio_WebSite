                ...
                <form id="standaloneContactForm" onsubmit="handleContactPageSubmit(event)" class="space-y-6">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex flex-wrap gap-1.5 text-xs">
                            ...
                            <button type="button" onclick="setContactSubject('IMITERRA / Climate-Tech MRV Platform', this)" class="quick-sub-btn px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 glass-card text-slate-600 dark:text-slate-300 hover:border-emerald-500 hover:text-emerald-600 transition">🌿 Climate MRV Platform</button>
